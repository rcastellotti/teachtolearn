...
def required_env_var(name):
    var = os.getenv(name)
    if var is None or var == "":
        raise Exception(f"Required env variable {name} is not set or is empty")
    return var
...
IS_TEST = FLASK_ENV == "testing"
FROM_EMAIL = "ttl@rcastellotti.dev"
# FROM_EMAIL="noreply@teachtolearn.club"
COLORS = [
    "slate",
    "gray",
    "zinc",
